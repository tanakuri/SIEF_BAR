...
function open(){
	gBrowser.selectedTab = gBrowser.addTab('chrome://siefbar/content/siefbarframe.xul');
	var newTabBrowser = gBrowser.getBrowserForTab(document.getElementById('myapp-report-frame'));
